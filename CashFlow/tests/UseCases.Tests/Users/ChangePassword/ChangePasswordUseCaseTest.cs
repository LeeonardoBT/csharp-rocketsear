...
public class ChangePasswordUseCaseTest
{
    ...
    [Fact]
    public async Task ErrorEmptyNewPassword()
    {
        var user = UserBuilder.Build();
    ...
    [Fact]
    public async Task ErrorDifferentCurrentPassword()
    {
        var user = UserBuilder.Build();
        ...
        result.Where(e => e.GetErrors().Count == 1 && e.GetErrors().Contains(ResourceErrorMessages.WRONG_PASSWORD));
    }
