...
public class ChangePasswordTest : CashFlowClassFixture
{
    ...
    private const string LOGIN_METHOD = "api/Login";
    ...
    public async Task ErrorWrongCurrentPassword(string culture)
    {
        var request = RequestChangePasswordJsonBuilder.Build();
        ...
        var expectedMessage = ResourceErrorMessages.ResourceManager.GetString("WRONG_PASSWORD", new CultureInfo(culture));
